...
public class Applicant {
	...
	public Applicant(Integer id, String name, Double subject1Mark, Double subject2Mark, Double subject3Mark, Double total,
			Double percentage) {
		super();
		this.id = id;
	...
	public String toString() {
		String output= String.format("%-5s %-10s %-5s %-5s %-5s %-10s %-10s",id,name,subject1Mark,subject2Mark,subject3Mark);
		return output;
	}
